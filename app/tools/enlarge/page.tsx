...
export default function EnlargePage() {
  ...
  const handleDownload = async () => {
    ...
    // If resultImage is a URL, fetch and download
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Upload an image and we'll enlarge it using AI super-resolution
          </p>
        </div>
        ...
        {(originalImage || resultImage) && (
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            ...
            <div>
              <h3 className="text-center font-semibold text-gray-700 mb-3">Upscaled</h3>
              <div className="aspect-square bg-gray-100 rounded-xl overflow-hidden flex items-center justify-center">
                {resultImage ? (
